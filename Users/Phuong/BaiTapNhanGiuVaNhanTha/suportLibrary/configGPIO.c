...
void configEXTI_GPIO(uint8_t EXTI_PortSourceGPIOx, uint8_t EXTI_PinSourcex, uint32_t EXTI_Linex, EXTITrigger_TypeDef EXTI_Trigger)
{
...
void configGpioE3HaveIRQ(void)
{
	...
	configEXTI_GPIO(EXTI_PortSourceGPIOE, EXTI_PinSource3, EXTI_Line3,EXTI_Trigger_Falling);
...
void configGpioE4HaveIRQ(void)
{
	...
	configEXTI_GPIO(EXTI_PortSourceGPIOE, EXTI_PinSource4, EXTI_Line4, EXTI_Trigger_Rising_Falling);
